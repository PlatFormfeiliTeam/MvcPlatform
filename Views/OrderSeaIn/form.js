function form_ini() {
    ...
    var bbar_r = '<div class="btn-group" role="group">'
                        ...
                        + '<button type="button" onclick="add_new(21)" id="btn_add_create" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-fw"></i>&nbsp;新增</button>'
                        + '<button type="button" onclick="copyorder(21)" id="btn_copyadd_create" class="btn btn-primary btn-sm"><i class="fa fa-files-o"></i>&nbsp;复制新增</button>'
                        + '<button type="button" onclick="save(\'save\',21)" id="btn_saveorder" class="btn btn-primary btn-sm"><i class="fa fa-floppy-o"></i>&nbsp;保存</button>'
