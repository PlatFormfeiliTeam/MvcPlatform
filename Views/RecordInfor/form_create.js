function form_ini() {
    ...
    var combo_HSCODE = Ext.create('Ext.form.field.ComboBox', {
        id: 'HSCODE', flex: 0.75, margin: 0, minChars: 4,
    ...
    var combo_ADDITIONALNO = Ext.create('Ext.form.field.ComboBox', {
        id: 'ADDITIONALNO', flex: 0.25, margin: 0, minChars: 1,
        name: 'ADDITIONALNO', maxLength: 2, minLength: 2, enforceMaxLength: true,
    ...
    var hs_container = {
        ...
        layout: 'hbox',
        fieldLabel: 'HS编码/附加码',
        items: [combo_HSCODE, combo_ADDITIONALNO]
    }
...
function form_ini_btn() {
    ...
    var bbar_r = '<div class="btn-group" role="group">'
                        + '<button type="button" onclick="printitemno_create()" id="btn_print" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>&nbsp;申请表打印</button>'
...
function formpanelcontrol() {
    ...
    document.getElementById("btn_cancelsubmit").disabled = (status == 0 || status==50);//撤回:只有草稿、确认完成 才不可以撤回  
