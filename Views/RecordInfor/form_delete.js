function form_ini() {
    ...
    var configItem = [
        ...
        field_CUSTOMERNAME, field_CREATEID, field_SUBMITID, field_ACCEPTID, field_PREID, field_REPID, field_FINISHID, field_RID
    ];
...
function form_ini_btn() {
    ...
    var bbar_r = '<div class="btn-group" role="group">'
                        + '<button type="button" onclick="printitemno_delete()" id="btn_print" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>&nbsp;申请表打印</button>'
