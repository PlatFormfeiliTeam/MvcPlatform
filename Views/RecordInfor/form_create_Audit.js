function form_ini_Audit() {
    ...
    var field_ADDITIONALNO = Ext.create('Ext.form.field.Text', {
        id: 'ADDITIONALNO',
        name: 'ADDITIONALNO', readOnly: true,
        flex: 0.25, margin: 0,
        maxLength: 2,
        minLength: 2,
    ...
    var field_COMMODITYNAME = Ext.create('Ext.form.field.Text', {
        id: 'COMMODITYNAME',
        name: 'COMMODITYNAME', readOnly: true,
        fieldLabel: '商品名称',
        listeners: {
            change: function (field_paste, newValue, oldValue, eOpts) {
    ...
    var field_SPECIFICATIONSMODEL = Ext.create('Ext.form.field.Text', {
        ...
        name: 'SPECIFICATIONSMODEL', readOnly: true,
        fieldLabel: '规格型号'
    });
    ...
    var configItem = [
        { layout: 'column', height: 42, margin: '5 0 0 0', border: 0, items: [combo_enterprise, field_RECORDINFONAME, combo_CUSTOMAREA, combo_CUSTOMER] },
