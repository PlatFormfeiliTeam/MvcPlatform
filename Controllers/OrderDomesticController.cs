    ...
    public class OrderDomesticController : Controller
    {
        ...
        public string loadform()
        {
            ...
            else
            {
                string sql_pre = @"select ID,CODE,BUSITYPE,CUSNO,BUSIUNITCODE,BUSIUNITNAME,CONTRACTNO,CLEARANCENO,LAWFLAG,GOODSNUM,REPWAYID
                      ...
                      ,CUSTOMERNAME,CREATEUSERNAME,SUBMITUSERNAME,RECORDCODE,TRADEWAYCODES1,ASSOCIATEPEDECLNO
        ...
        public string Save()
        {
            ...
            update_sql = @"update LIST_ORDER  SET ASSOCIATEPEDECLNO='{0}',CUSNO='{1}',BUSIUNITCODE='{2}',BUSIUNITNAME='{3}',CONTRACTNO='{4}',GOODSNUM='{5}'
                                    ...
                                    ,GOODSGW='{21}',GOODSNW='{22}',RECORDCODE='{23}',TRADEWAYCODES1='{24}',IETYPE='{25}'
            ...
            if (!string.IsNullOrEmpty(code1))//如果code1不为空 
            {
                if (string.IsNullOrEmpty(json1.Value<string>("CODE")))//新增
                {
                    sql = string.Format(insert_sql
                            ...
                            , json1.Value<string>("STATUS"), json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json1.Value<string>("TRADEWAYCODES"), AssociateNo
                            ...
                            , json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json_head1.Value<string>("SUBMITTIME"), json_head1.Value<string>("CUSTOMAREACODE")
                         );
            ...
            if (!string.IsNullOrEmpty(code2))
            {
                if (string.IsNullOrEmpty(json2.Value<string>("CODE")))//新增
                {
                    sql = string.Format(insert_sql, "40", json2.Value<string>("ASSOCIATEPEDECLNO"), code2, json2.Value<string>("CUSNO"), json2.Value<string>("BUSIUNITCODE"),json2.Value<string>("BUSIUNITNAME")
                            ...
                            , json2.Value<string>("STATUS"), json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json2.Value<string>("TRADEWAYCODES"), AssociateNo
            ...
            if (!string.IsNullOrEmpty(code3))
            {
                if (string.IsNullOrEmpty(json3.Value<string>("CODE")))//新增
                {
                    sql = string.Format(insert_sql
                            ...
                            , json3.Value<string>("STATUS"), json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json3.Value<string>("TRADEWAYCODES"), AssociateNo2
                            ...
                            , json_head2.Value<string>("SUBMITUSERNAME"), json_head2.Value<string>("SUBMITUSERID"), json3.Value<string>("ASSOCIATETRADEWAY"), "002", "1"
                             , json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json_head2.Value<string>("SUBMITTIME"), json_head2.Value<string>("CUSTOMAREACODE")
                         );
                    order_res = DBMgr.ExecuteNonQuery(sql);
                    ordercode = code3;
                }
            ...
            if (!string.IsNullOrEmpty(code4))
            {
                if (string.IsNullOrEmpty(json4.Value<string>("CODE")))//新增
                {
                    sql = string.Format(insert_sql
                            ...
                            , json4.Value<string>("STATUS"), json_user.Value<string>("CUSTOMERHSCODE"), json_user.Value<string>("CUSTOMERNAME"), json4.Value<string>("TRADEWAYCODES"), AssociateNo2
