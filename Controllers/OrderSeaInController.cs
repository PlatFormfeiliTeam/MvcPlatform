        ...
        public string Save()
        {
            ...
            if (string.IsNullOrEmpty(json.Value<string>("CODE")))//新增
            {
                ...
                sql = @"INSERT INTO LIST_ORDER (ID
                            ...
                            ,PAYPOYALTIES,DECLSTATUS,INSPSTATUS,DOCSERVICECODE,CLEARREMARK
                ...
                sql = string.Format(sql
                    ...
                    , "1", json.Value<string>("CLEARUNIT"), json.Value<string>("CLEARUNITNAME"), json.Value<string>("SHIPNAME"), json.Value<string>("FILGHTNO")
                    ...
                    , GetChk(json.Value<string>("PAYPOYALTIES")), json.Value<string>("DECLSTATUS"), json.Value<string>("INSPSTATUS"), json.Value<string>("DOCSERVICECODE"), json.Value<string>("CLEARREMARK")
            ...
            else//修改
            {
                ...
                */
                string allcol = @"CODE
                                ...
                                ,DECLSTATUS,INSPSTATUS,CLEARREMARK,RECEIVERUNITCODE,RECEIVERUNITNAME    
                            ";
                ...
                if (sql != "")
                {
                    sql = string.Format(sql, ordercode
                        ...
                        , json.Value<string>("CONTAINERNO"), GetChk(json.Value<string>("SPECIALRELATIONSHIP")), GetChk(json.Value<string>("PRICEIMPACT")), GetChk(json.Value<string>("PAYPOYALTIES")), json.Value<string>("DOCSERVICECODE")
                        , json.Value<string>("DECLSTATUS"), json.Value<string>("INSPSTATUS"), json.Value<string>("CLEARREMARK"), json_user.Value<string>("CUSTOMERCODE"), json_user.Value<string>("CUSTOMERNAME")                        
                    );
                }
